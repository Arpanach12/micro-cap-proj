...
public class KafkaConfiguration {
	...
	@Bean
	public ConsumerFactory<String,ReviewDto> userConsumerFactory(){
	...
	config.put(ErrorHandlingDeserializer2.KEY_DESERIALIZER_CLASS, deserializer);
    config.put(ErrorHandlingDeserializer2.VALUE_DESERIALIZER_CLASS, deserializer.getClass());
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String,ReviewDto> userListenerFactory(){
